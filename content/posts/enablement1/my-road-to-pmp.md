# From Project Manager to PMP: My Road to Certification

*February 27, 2026 — the date on my certificates. A day I'll remember for a while.*
...
The PMP is widely regarded as the gold standard in project management credentials. It signals not just that you understand the theory, but that you've earned real-world experience managing projects and can demonstrate it. The exam itself is notoriously difficult — 180 situational questions designed to test whether you *think* like a project manager, not just memorize frameworks. About 50% of the content leans on agile and hybrid methodologies, the other half on predictive approaches. Passing above target across all three domains (People, Process, and Business Environment) requires internalizing an entire mindset shift.

Getting to the exam first required 35 hours of verified project management education. That's where my journey really began.

---

## Andrew Ramdayal: The Instructor Who Changes How You Think

If you've spent any time in PMP prep circles, you've heard the name **Andrew Ramdayal**. He holds over 60 professional certifications in IT and accounting from vendors including Microsoft, Cisco, CompTIA, and PMI, and has a Master's Degree in Management Information Systems with a minor in project management. He's been teaching PMP and information security courses for over 20 years to thousands of students around the world.
...
The TIA Education Group also issued me a formal **Certificate of Completion** for the 001 — Project Management Professional Exam Prep course, dated February 27, 2026, signed by Andrew himself as Director. That certificate, alongside the Udemy completion record, went directly into my PMI application.
...
After working through all 382 questions, tracking my errors, and revisiting the concepts I was getting wrong, I felt genuinely ready — not just rehearsed. Ray's simulator earns its place in any serious PMP study plan.

---

## Ricardo Vargas: The Flow That Made It All Click

Some concepts in project management don't fully land until you *see* them. That's where **Ricardo Viana Vargas** came in.
...
## The Stack That Got Me Across the Line

By February 27, 2026, I had:
...
The exam itself was everything the mock tests prepared me for: relentless situational scenarios, questions where two answers look equally reasonable and you have to choose the *most correct* one, and a constant demand to think from the project manager's perspective rather than your own instincts.
...
If you're preparing for your PMP, here's what worked for me:

**Start with Andrew Ramdayal.** His 35-hour Udemy course is both your required education hours and your conceptual foundation. Don't rush it. The "PM Mindset" he teaches is the entire point.

**Stress-test yourself with Nilotpal Ray's simulator.** Do the diagnostic first to find your weak spots, then work through the full exam under timed conditions. Review every wrong answer — not just the right answer, but *why* the other options were wrong.

**Print Ricardo Vargas's flow diagram.** Tape it to your wall. Refer to it constantly. When something in the PMBOK doesn't make sense in isolation, find it on the flow and look at what it connects to.

The PMP isn't just a credential. The process of earning it genuinely changed how I think about project work — how I frame problems, prioritize responses, and consider the ripple effects of decisions across scope, schedule, cost, and people. That, more than the letters after my name, is the real return on the investment.

---

*If you're on your own PMP journey and have questions about any of these resources, feel free to reach out.*
